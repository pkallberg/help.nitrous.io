...
* Nitrous.IO box with the package manager Autoparts installed. To version `bran` or later. If using version `arya`, please refer to our [upgrading guide](/upgrade-box/) before proceeding.
